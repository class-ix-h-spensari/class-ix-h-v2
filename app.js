...
const siswaData = [
  { no: 1, nama: 'Afiqa Khairunnisa', gender: 'P', cita: 'Polwan', nisn: '2026.IXH.001' },
  { no: 2, nama: 'Agisti Safa Nur Ramadhani', gender: 'P', cita: 'Kriminolog', nisn: '2026.IXH.002' },
  { no: 3, nama: 'Aira Nisathaullah Mumtazah', gender: 'P', cita: 'Penulis', nisn: '2026.IXH.003' },
  { no: 4, nama: 'Awal Nur Ardiansyah', gender: 'L', cita: 'Pengusaha', nisn: '2026.IXH.004' },
  { no: 5, nama: 'Axzaan May Ash Haabal', gender: 'L', cita: 'Bos Muda', nisn: '2026.IXH.005' },
  { no: 6, nama: 'Azam Setia Pratama', gender: 'L', cita: 'Pengusaha', nisn: '2026.IXH.006' },
  { no: 7, nama: 'Fauzan Setiawan', gender: 'L', cita: 'Pengusaha', nisn: '2026.IXH.007' },
  { no: 8, nama: 'Firsta Septiasa Nur Fitri', gender: 'P', cita: 'Dokter', nisn: '2026.IXH.008' },
  { no: 9, nama: 'Ghani Putra Akmal Muazzam', gender: 'L', cita: 'Pengusaha', nisn: '2026.IXH.009' },
  { no: 10, nama: 'Haliza Lutfia Tunisa', gender: 'P', cita: 'Polwan', nisn: '2026.IXH.010' },
  { no: 11, nama: 'Herul Arifien', gender: 'L', cita: 'CEO', nisn: '2026.IXH.011' },
  { no: 12, nama: 'Hikmal Syukri Febriyanto', gender: 'L', cita: 'Hakim', nisn: '2026.IXH.012' },
  { no: 13, nama: 'Intan Nuraeni', gender: 'P', cita: 'Koki', nisn: '2026.IXH.013' },
  { no: 14, nama: 'Ismia Arum', gender: 'P', cita: 'Dokter', nisn: '2026.IXH.014' },
  { no: 15, nama: 'Mahfiz Verona', gender: 'P', cita: 'Polwan', nisn: '2026.IXH.015' },
  { no: 16, nama: 'Maida Astagina Hernawayanto', gender: 'P', cita: 'Guru', nisn: '2026.IXH.016' },
  { no: 17, nama: 'Muhammad Ikhsan Maulana', gender: 'L', cita: 'Pengusaha', nisn: '2026.IXH.017' },
  { no: 18, nama: 'Muhammad Iqbal Nur Hidayat', gender: 'L', cita: 'Pengusaha', nisn: '2026.IXH.018' },
  { no: 19, nama: 'Rafael Dimas Saputra', gender: 'L', cita: 'Bos Muda', nisn: '2026.IXH.019' },
  { no: 20, nama: 'Rafi Azka Zaidan', gender: 'L', cita: 'TNI-AL', nisn: '2026.IXH.020' },
  { no: 21, nama: 'Reza Nur Pratama', gender: 'L', cita: 'CEO', nisn: '2026.IXH.021' },
  { no: 22, nama: 'Reziqq Syah Nur Syarif', gender: 'L', cita: 'TNI-AD', nisn: '2026.IXH.022' },
  { no: 23, nama: 'Rifki Dias Aldiansah', gender: 'L', cita: 'Owner Bus', nisn: '2026.IXH.023' },
  { no: 24, nama: 'Rizky Afif Pratama', gender: 'L', cita: 'Pengusaha', nisn: '2026.IXH.024' },
  { no: 25, nama: 'Rizqa Ramadhani', gender: 'P', cita: 'Dokter', nisn: '2026.IXH.025' },
  { no: 26, nama: 'Rizqi Jilan Aprilian P', gender: 'L', cita: 'CEO', nisn: '2026.IXH.026' },
  { no: 27, nama: 'Sabian Hafizh Faiddlurahman', gender: 'L', cita: 'Masinis', nisn: '2026.IXH.027' },
  { no: 28, nama: 'Sabrina Nur Salsabila', gender: 'P', cita: 'Direktur Tambang', nisn: '2026.IXH.028' },
  { no: 29, nama: 'Safa Nurul Afifah', gender: 'P', cita: 'Pramugari', nisn: '2026.IXH.029' },
  { no: 30, nama: 'Syafii Nur Fadilah', gender: 'L', cita: 'Pemain Bola', nisn: '2026.IXH.030' },
  { no: 31, nama: 'Tria Nur Aisyahrani', gender: 'P', cita: 'Guru', nisn: '2026.IXH.031' },
  { no: 32, nama: 'Vanesh Amelia Putri', gender: 'P', cita: 'Polwan', nisn: '2026.IXH.032' }
];
...
function renderStruktur() {
  ...
  level1.innerHTML = `
    <div class="org-card leader">
      ...
      <div class="org-avatar-wrap">
        <div class="org-avatar">${wali.nama.split(' ').map(n=>n[0]).slice(0,2).join('')}</div>
      </div>
  ...
  ketuaWakil.forEach(item => {
    ...
    card.innerHTML = `
      ...
      <div class="org-avatar-wrap">
        <div class="org-avatar">${item.nama.split(' ').map(n=>n[0]).slice(0,2).join('')}</div>
      </div>
...
const scheduleData = {
  senin: {
    ...
    piketTitle: "Petugas Piket Senin",
    piket: ['Afiqa Khairunnisa', 'Awal Nur Ardiansyah', 'Hikmal Syukri', 'Safa Nurul', 'Vanesh Amelia'],
    lessons: [
  ...
  selasa: {
    ...
    piketTitle: "Petugas Piket Selasa",
    piket: ['Agisti Safa', 'Axzaan May', 'Intan Nuraeni', 'Firsta Septiasa', 'Sabian Hafizh'],
    lessons: [
  ...
  rabu: {
    ...
    piketTitle: "Petugas Piket Rabu",
    piket: ['Aira Nisathaullah', 'Azam Setia', 'Ismia Arum', 'Muhammad Ikhsan', 'Sabrina Nur'],
    lessons: [
  ...
  kamis: {
    ...
    piketTitle: "Petugas Piket Kamis",
    piket: ['Fauzan Setiawan', 'Haliza Lutfia', 'Mahfiz Verona', 'Muhammad Iqbal', 'Syafii Nur'],
    lessons: [
  ...
  jumat: {
    ...
    piketTitle: "Petugas Piket Jumat",
    piket: ['Firsta Septiasa', 'Herul Arifien', 'Maida Astagina', 'Rafael Dimas', 'Tria Nur'],
    lessons: [
  ...
  sabtu: {
    ...
    piketTitle: "Petugas Piket Sabtu",
    piket: ['Ghani Putra', 'Rafi Azka', 'Reza Nur', 'Reziqq Syah', 'Rizqa Ramadhani'],
    lessons: [
...
// ---------- 5. DOKUMENTASI & LIGHTBOX ----------
const dokData = [
  { img: 'dok1.jpg', caption: 'Kekompakan Penghuni IX-H di Lapangan Utama Spensari', cat: 'kegiatan' },
  { img: 'dok2.jpg', caption: 'Penyerahan Piala Juara 1 Lomba Kebersihan Kelas', cat: 'prestasi' },
  { img: 'dok3.jpg', caption: 'Dekorasi Horror Class Spensari Halloween Special', cat: 'horor' },
  { img: 'dok4.jpg', caption: 'Sesi Belajar Bersama & Persiapan Ujian Sekolah', cat: 'kegiatan' },
  { img: 'dok5.jpg', caption: 'Kunjungan Edukasi Museum & Cagar Budaya', cat: 'kegiatan' },
  { img: 'dok6.jpg', caption: 'Kenangan Manis Kebersamaan Seluruh Penghuni IX-H', cat: 'horor' }
];

function renderGaleri(filter = 'all') {
  const grid = document.getElementById('dokumentasiGrid');
  if (!grid) return;
  grid.innerHTML = '';

  const filtered = dokData.filter(d => filter === 'all' || d.cat === filter);
  filtered.forEach(d => {
    const card = document.createElement('div');
    card.className = 'gallery-card';
    card.innerHTML = `
      <img src="${d.img}" class="gallery-img" alt="${d.caption}" onerror="this.src='acara1.jpg';">
  ...
  messages.forEach(m => {
    ...
    card.innerHTML = `
      ...
      <div class="message-reactions">
        <button class="reaction-btn" data-type="ghost">👻 <span>${m.reactions?.ghost || 0}</span></button>
        <button class="reaction-btn" data-type="candle">🕯️ <span>${m.reactions?.candle || 0}</span></button>
        <button class="reaction-btn" data-type="skull">💀 <span>${m.reactions?.skull || 0}</span></button>
      </div>
    `;
...
document.getElementById('madingSubmitBtn')?.addEventListener('click', async function() {
  ...
  try {
    if (window.addGuestbookMessage) {
      await window.addGuestbookMessage(author, selectedAvatar, text);
    } else {
